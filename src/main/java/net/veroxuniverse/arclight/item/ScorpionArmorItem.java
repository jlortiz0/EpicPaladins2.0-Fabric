...
public class ScorpionArmorItem extends GeckoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.SCORPIONSCALE, new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 200, 1, false, false)).build();

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.SCORPIONSCALE, new StatusEffectInstance(StatusEffects.STRENGTH, 200, 1, false, false)).build();
