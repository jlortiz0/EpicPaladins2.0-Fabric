...
public class JadeArmorItem extends GeckoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.JADE, new StatusEffectInstance(StatusEffects.JUMP_BOOST, 200, 1, false, false)).build();

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.JADE, new StatusEffectInstance(StatusEffects.LUCK, 200, 1, false, false)).build();
