...
public class CryoArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorMaterialsInit.CRYO, new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 200, 1, false, false)).build();
