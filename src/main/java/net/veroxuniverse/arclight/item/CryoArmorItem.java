...
public class CryoArmorItem extends GeckoArmorItem implements IAnimatable {
    ...
    private static final Set<StatusEffectInstance> EFFECT_SET =
            (new ImmutableSet.Builder<StatusEffectInstance>())
                    .add(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 200, 1, false, false))
                    .add(new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 200, 1, false, false)).build();
