...
public class CryoArmorItem extends GeckoArmorItem implements IAnimatable {
    private final AnimationFactory FACTORY = GeckoLibUtil.createFactory(this);

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.CRYO, new StatusEffectInstance(StatusEffects.WATER_BREATHING, 200, 1, false, false)).build();

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.CRYO, new StatusEffectInstance(StatusEffects.DOLPHINS_GRACE, 200, 1, false, false)).build();

    public CryoArmorItem(ArmorMaterial material, EquipmentSlot slot, Item.Settings settings) {
