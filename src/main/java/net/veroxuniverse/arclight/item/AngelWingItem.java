...
public class AngelWingItem extends GeckoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.ANGEL, new StatusEffectInstance(StatusEffects.REGENERATION, 200, 0, false, false)).build();
    ...
    // TODO: Use mixin on PlayerEntity.checkFallFlying to allow this to fly
