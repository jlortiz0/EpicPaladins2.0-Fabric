...
public class AngelWingItem extends GeoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorMaterialsInit.ANGEL, new MobEffectInstance(MobEffects.REGENERATION, 200, 0, false, false)).build();

    public AngelWingItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
