...
public class MoonlightArmorItem extends GeoArmorItem implements IAnimatable {
    ...
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorMaterialsInit.MOONLIGHT, new MobEffectInstance(MobEffects.DAMAGE_BOOST, 200, 1, false, false)).build();

    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ArmorMaterialsInit.MOONLIGHT, new MobEffectInstance(MobEffects.NIGHT_VISION, 200, 1, false, false)).build();
