...
public class MoonlightArmorItem extends GeckoArmorItem implements IAnimatable {
    private final AnimationFactory FACTORY = GeckoLibUtil.createFactory(this);

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.MOONLIGHT, new StatusEffectInstance(StatusEffects.STRENGTH, 200, 1, false, false)).build();

    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP2 =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ArmorMaterialsInit.MOONLIGHT, new StatusEffectInstance(StatusEffects.NIGHT_VISION, 200, 1, false, false)).build();

    public MoonlightArmorItem(ArmorMaterial material, EquipmentSlot slot, Item.Settings settings) {
