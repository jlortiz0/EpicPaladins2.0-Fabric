...
public class ItemsInit {
 ...
 //Armor
    ...
    public static final Item SCORPION_HELMET = registerItem("scorpion_helmet",
            () -> new ScorpionArmorItem(ArmorMaterialsInit.SCORPIONSCALE, EquipmentSlot.HEAD, new Item.Settings().group(ArclightModCreativeTabs.ARCLIGHT_TAB)));
    public static final Item SCORPION_CHESTPLATE = registerItem("scorpion_chestplate",
            () -> new ScorpionArmorItem(ArmorMaterialsInit.SCORPIONSCALE, EquipmentSlot.CHEST, new Item.Settings().group(ArclightModCreativeTabs.ARCLIGHT_TAB)));
    public static final Item SCORPION_LEGGINGS = registerItem("scorpion_leggings",
            () -> new ScorpionArmorItem(ArmorMaterialsInit.SCORPIONSCALE, EquipmentSlot.LEGS, new Item.Settings().group(ArclightModCreativeTabs.ARCLIGHT_TAB)));
    public static final Item SCORPION_BOOTS = registerItem("scorpion_boots",
            () -> new ScorpionArmorItem(ArmorMaterialsInit.SCORPIONSCALE, EquipmentSlot.FEET, new Item.Settings().group(ArclightModCreativeTabs.ARCLIGHT_TAB)));
    ...
    public static final Item BLOODSTONE_AXE = registerItem("bloodstone_axe",
            () -> new AxeItem(ItemMaterialsInit.BLOODSTONE,1,-3f, new Item.Settings().group(ArclightModCreativeTabs.ARCLIGHT_TAB)));
    ...
    public static final Item CRYORIUM_AXE = registerItem("cryorium_axe",
            () -> new AxeItem(ItemMaterialsInit.CRYORIUM,1,-3f, new Item.Settings().group(ArclightModCreativeTabs.ARCLIGHT_TAB)));
